...
class ProductCategoryAdmin(ModelView, model=ProductCategory):
    ...
    column_searchable_list = ["product_id", "category_id"]
...
class CategoryAdmin(ModelView, model=Category):
    column_list = [Category.id, Category.title, Category.is_active, Category.parent]
...
class StockRecordAdmin(ModelView, model=StockRecord):
    ...
    column_searchable_list = ["price", "quantity"]
...
class ProductDiscountAdmin(ModelView, model=ProductDiscount):
    ...
    column_searchable_list = ["valid_from", "valid_to"]
