...
from src.catalogue.services import (
    get_product_service, AdditionalProductsService, get_additional_products_service,
    RecommendedProductsService, get_recommended_products_service
)
...
async def update_additional_product(
    ...
    """
    return await service.update_additional_product(primary_id=product_id, additional_id=new_additional_id)
...
async def remove_additional_product(
    ...
    """
    await service.remove_additional_product(primary_id=product_id, additional_id=additional_id)
...
async def list_additional_products(
    ...
    """
    return await service.list_additional_products(primary_id=product_id)
...
async def update_recommended_product(
    ...
    """
    return await service.update_recommended_product(primary_id=product_id, recommended_id=new_recommended_id)
...
async def remove_recommended_product(
    ...
    Returns:
        Response with no content.
    """
    await service.remove_recommended_product(primary_id=product_id, recommended_id=recommended_id)
    return Response(status_code=status.HTTP_204_NO_CONTENT)
...
async def list_recommended_products(
    ...
    """
    return await service.list_recommended_products(primary_id=product_id)
